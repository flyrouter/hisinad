...
int main(int argc, char** argv)
{
    ...
    tinydraw_renderer_draw_char(&td_ctx, 10, 0, &tinydraw_font_monaco32, 'A');
    tinydraw_renderer_draw_char(&td_ctx, 40, 0, &tinydraw_font_monaco32, 'B');
    tinydraw_renderer_draw_char(&td_ctx, 15, 35, &tinydraw_font_monaco32, 'Y');
    tinydraw_renderer_draw_char(&td_ctx, 35, 35, &tinydraw_font_monaco32, 'W');
