...
void sensor_init()
{
	...
	// chip_id = 0x2
	sensor_write_register(0x207, 0x00); // was 0x10
	sensor_write_register(0x209, 0x11); // was 0x01
	...
	sensor_write_register(0x218, 0x40); // was 0xee
	sensor_write_register(0x219, 0x0a); // was 0x0a
	sensor_write_register(0x21b, 0xa0); // was 0xc8
	sensor_write_register(0x21c, 0x11); // was 0x19
	sensor_write_register(0x21d, 0xc2);
    sensor_write_register(0x246, 0x00); // was 0x03
    sensor_write_register(0x247, 0x08); // was 0x06
    sensor_write_register(0x248, 0x00); // was 0xc2
    sensor_write_register(0x249, 0x0a); // was ----
    sensor_write_register(0x232, 0x4c); // was ----
	sensor_write_register(0x25c, 0x2c);
	sensor_write_register(0x25D, 0x00);
	sensor_write_register(0x25E, 0x2c);
	...
	sensor_write_register(0x3df, 0x53);
