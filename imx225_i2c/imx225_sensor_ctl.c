...
void sensor_init()
{
	...
	// chip_id = 0x2
	sensor_write_register(0x3007, 0x10); //Window mode:720p mode
	sensor_write_register(0x3009, 0x01); //30fps mode
	...
	sensor_write_register(0x301b, 0xc8);
	sensor_write_register(0x301c, 0x19);
	sensor_write_register(0x301d, 0xc2);
    sensor_write_register(0x3046, 0x03);
    sensor_write_register(0x3047, 0x06);
	...
	usleep(200000);
	sensor_write_register(0x3002, 0x00); //Master mose start
	usleep(200000);
