...
// pianisteg: changed from 1 to 0
#define CMOS_IMX225_ISP_WRITE_SENSOR_ENABLE (0)
...
#define EXPOSURE_ADDR (0x3020) //2:chip_id, 0C: reg addr.

#define PGC_ADDR (0x3014)
...
#define GAIN_TBL_SIZE 721 /* == (int)(SNS_GAIN_MAX / GAIN_PRECISE + 1) */
...
static HI_U32 gain_table[GAIN_TBL_SIZE] = {
...
static HI_VOID cmos_gains_update(HI_U32 u32Again, HI_U32 u32Dgain)
{
   ...
   u32Tmp = u32Tmp > (GAIN_TBL_SIZE - 1) ? (GAIN_TBL_SIZE - 1) : u32Tmp;
    ...
    sensor_write_register(PGC_ADDR+1, (u32Tmp >> 8) & 0x3);
#endif
    return;
}
